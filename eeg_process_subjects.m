function eeg_process_subjects(controlFile)
...
for i=1:nSubjects
    ...
    % 3.2 - Import binlist
    EEG  = pop_binlister( EEG , 'BDF', 'D:\Data\LangSwitch\BDF_v2.txt', 'IndexEL',  1, 'SendEL2', 'EEG', 'UpdateEEG', 'on', 'Voutput', 'EEG' ); % GUI: 10-Jul-2024 22:47:38
